...
public class BillSummaryPage {
	
	public static BillSummaryPage instance = null;
	
	private BillSummaryPage() {}
	
	public static BillSummaryPage getInstance() {
			if (instance == null) {
			instance = new BillSummaryPage();
		}
		return instance;
	}
//###################################################################################################################################
	
	@FindBy(xpath="//*[contains(@href,'billStatus')]")
	...
	@FindBy(xpath="//*[contains(text(),'Electricity Consumption Bill Details')]/ancestor::table[1]/tbody/tr")
	public List<WebElement> billHistoryTable;
